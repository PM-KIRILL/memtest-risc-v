...
#define MAX_MEM         0x7FF00000      /* 8 ТБ */
#define WIN_SZ          0x80000         /* 2 ГБ */
#define UNMAP_SZ        (0x100000-WIN_SZ)  /* Размер первого неотображенного сегмента */

#define SPINSZ		0x4000000	/* 256 МБ */
#define MOD_SZ		20
...
/* Операции измерения скорости памяти */
#define MS_COPY		1
#define MS_WRITE	2
#define MS_READ		3
...
/* Определение общих переменных для разных перемещений (relocations) memtest86 */
struct vars {
	int pass;
	int msg_line;
	int ecount;
